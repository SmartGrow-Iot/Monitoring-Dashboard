...
const plantProfiles = [
  {
    ...
    careNotes: 'Water when top inch of soil is dry. Prefers full sun exposure. Harvest peppers when bright red.'
  },
  {
    id: 'eggplant',
    name: 'Eggplant',
    ...
    careNotes: 'Regular watering needed. Ensure good drainage. Harvest when skin is glossy and firm to touch.'
  }
];
...
const PlantProfiles = () => {
  ...
  const handleAddPlant = (e) => {
    e.preventDefault();
    // In a real app, this would make an API call to save the new plant
        ...
        {plantProfiles.map(plant => (
          <div key={plant.id} className="card hover:shadow-lg transition-shadow">
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                ...
                <div>
                  ...
                  <p>{plant.thresholds.humidity.min}% - {plant.thresholds.humidity.max}%</p>
                </div>
                <div>
                  <p className="text-neutral-500">Air Quality:</p>
                  <p>{plant.thresholds.air_quality.min}ppm - {plant.thresholds.air_quality.max}ppm</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <p className="text-sm text-neutral-600">{plant.careNotes}</p>
            </div>
            ...
            <div className="flex justify-end gap-2 pt-2 border-t border-neutral-100">
              ...
              <button 
                ...
                onClick={() => handleEditProfile(plant)}
              >
                Edit Profile
              </button>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 p-4 bg-neutral-50 rounded-lg">
                ...
                <div>
                  <p className="text-sm text-neutral-500">Air Quality</p>
                  <p className="font-medium">{selectedPlant.thresholds.air_quality.min} - {selectedPlant.thresholds.air_quality.max}</p>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      type="number"
                      value={editedPlant.thresholds.air_quality.min}
                      onChange={(e) => setEditedPlant({
                        ...editedPlant,
                        thresholds: {
                          ...editedPlant.thresholds,
                          air_quality: { ...editedPlant.thresholds.air_quality, min: Number(e.target.value) }
                        }
                      })}
                      className="w-20 rounded-md border border-neutral-300 px-2 py-1 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                    />
                    ...
                    <input
                      type="number"
                      value={editedPlant.thresholds.air_quality.max}
                      onChange={(e) => setEditedPlant({
                        ...editedPlant,
                        thresholds: {
                          ...editedPlant.thresholds,
                          air_quality: { ...editedPlant.thresholds.air_quality, max: Number(e.target.value) }
                        }
                      })}
                      className="w-20 rounded-md border border-neutral-300 px-2 py-1 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                    />
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      type="number"
                      value={newPlant.thresholds.air_quality.min}
                      onChange={(e) => setEditedPlant({
                        ...newPlant,
                        thresholds: {
                          ...newPlant.thresholds,
                          air_quality: { ...newPlant.thresholds.air_quality, min: Number(e.target.value) }
                        }
                      })}
                      className="w-20 rounded-md border border-neutral-300 px-2 py-1 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                    />
                    ...
                    <input
                      type="number"
                      value={newPlant.thresholds.air_quality.max}
                      onChange={(e) => setEditedPlant({
                        ...newPlant,
                        thresholds: {
                          ...newPlant.thresholds,
                          air_quality: { ...newPlant.thresholds.air_quality, max: Number(e.target.value) }
                        }
                      })}
                      className="w-20 rounded-md border border-neutral-300 px-2 py-1 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                    />
